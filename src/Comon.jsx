            ...
            <div className="container-fluid ">
              <div className="row">
                ...
                <div className="row">
                   ...
                   <div className="col-md-6 col-lg-6 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                      <h1>{props.name} <strong className="brand-name">HiteshMali</strong></h1>
